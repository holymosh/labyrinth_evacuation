    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            RegenertePlanButton.Click += (sender, args) =>
            {
                ...
                {
                    MessageBox.Show("Ivalid plan size. Every dimension must be integer");
                }
                else
                {
            ...
            {
                if (_planPresentor.CurrentSolution != null)
                {
                ...
                {
                    MessageBox.Show("Need some plan !!!");
                }
            };
        }
        ...
        private void RelocatePeople_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show(
                    "Invalid number of people. It must be integer");
            }
        }

        private void ShowDescriptionButton_Click(object sender, RoutedEventArgs e)
        {
            MessageBox.Show("Описание программы:" +
                            "\n Regenerate plan - генерирует лабиринт!!!" +
                            "\n Relocate people - генерирует людей!!!" +
                            "\n Relocate gates - генерирует выходы!!!" +
                            "\n Show units - генерирует людей и выходов!!!" +
                            "\n Start simulation - решение лабиринта!!!");
        }
    }
}